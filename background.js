...
function notify(req, sender, res) {
  switch (req.message) {
    ...
    case 'reset': console.log('reset in bg'); break;
...
function tabActivated(tabInfo) {
  console.log(tabInfo);
  sendTabMessage(tabInfo.tabId, 'reset', null, null);
  // if (bIsChrome) {
...
// (async () => {
//   const fibonacciURL = chrome.runtime.getURL("pkg/color_changer_bg.wasm");
//   try {
...
//     let colorChanger = instance.colorchanger_new();
//     console.log(`The *compiled* 42nd Fibonacci number is ${colorChanger}.`);
//   }
//   catch (e) {
